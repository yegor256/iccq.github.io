...
\begin{textblock}{7}[1,1](16,16)
  \includegraphics[width=7\TPHorizModule]{../../cfp/ekaterinburg}
\end{textblock}
...
\begin{textblock}{6}(10,4)
  \includegraphics[height=1.5in]{../../images/logo/logo.pdf}
@use 'common' as *;
...
\begin{textblock}{6}(10,7)
  \fontsize{14}{14}\selectfont\textbf{%
    ...
    December 2025, UrFU, Russia
  }
\end{textblock}

\begin{textblock}{6}(10,9)
  \fontsize{12}{12}\selectfont\textbf{%
  Edited by Yegor Bugayenko and Alexander Legalov}
\end{textblock}
